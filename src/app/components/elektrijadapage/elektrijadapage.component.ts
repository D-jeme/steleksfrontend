...
brojacElemenata: number=0;
  ...
  constructor() {
    this.slika1url='assets/images/embedded.jpg';
    this.slika2url='assets/images/aboutus.jpg';
    this.slika3url='assets/images/citaona1.jpg';
    this.slika4url='assets/images/elektrijada.jpg';
