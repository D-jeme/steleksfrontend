...
this.brojacElemenata=0;
    ...
    'Steleks je matično udruženje studenata Elektrotehničkog fakulteta u Sarajevu. Steleks je osnovan 22.11.1968 godine kao udruženje građana. Stvoren je da bi pomogao studentima pri ostvarivanju njihovih osnovnih prava tokom studija, što je ujedno i njegov primarni zadatak. Tokom vremena ova organizacija je dobijala na svome značaju i zauzela glavno mjesto u organizovanju studenata elektrotehnike. U okviru Steleksa organizovane su razne aktivnosti edukativnog, kulturnog, sportskog sadržaja.',
    'Društvo Studenata Elektrotehnike Steleks je osnovano 22.11.1968 u Sarajevu. Inicijatori cijele ideje, tj. osnivači Steleksa su Pavle Blum, Gojko Babić (prvi predsjednik Društva), Mašo Užičanin, Nikolina Milošević, Miro Vego, Zoran Dropulić, Andrija Batrolović, Dunja Uzunović, Mina Pilav, Mirsad Pirić, Pero Boro, Ibrahim Polimac, Emir Sefo i Mustafa Trklja (drugi predsjednik Društva). Ime Steleks je predložio Miro Vego, kao skraćenicu za STudentski ELEktrotehnički Klub i Servis. Steleks je svojim radom i zalaganjem članova 1976. godine od strane grada Sarajevo primio najveće priznanje, Šestoaprilsku Nagradu grada Sarajevo, s čime se malo koja organizacija na ovom podneblju moze pohvaliti. Stari Steleks je bio lociran na desnoj obali Miljacke, uzvodno od mosta Vrbanja, na adresi Gundulićeva 2 i tadašnjim brojem telefona 24-160. Poslije rata na tom mjestu je napravljen parking, te je Steleks premješten u prostorije glavne zgrade Elektrotehničkog Fakulteta u Sarajevu.',
    ...
    'Generalna tema objedinjuje sva četiri STEM područja - Science, Technology, Engineering i Mathematics te usmjerava natjecatelje i učesnike STEM Gamesa na pitanja i izazove s kojima se suočavamo. Na nju se naslanjaju podteme - specifični problemi koje će studenti rješavati i tako odmjeravati svoje znanje u STEM Games Arenama.',
    'Natjecanje iz znanja: Studentice i studenti odmjeravaju znanje u STEM Games Arenama - timskom trodnevnom natjecanju u rješavanju inženjerskih projektnih zadataka iz četiri područja.',
    ...
    'Zabavni program: Natjecateljsku atmosferu začinit će dobra zabava tokom dana i bogat noćni program na kojemu će se studenti imati priliku opustiti, upoznati i družiti.', this.pomocni, this.pomocni, this.pomocni, this.pomocni];
